...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      <sch:assert test="count(f:extension[@url = 'http://bha.colorado.gov/fhir/test/StructureDefinition/bha-ethnicity']) &gt;= 1">extension with URL = 'http://bha.colorado.gov/fhir/test/StructureDefinition/bha-ethnicity': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://bha.colorado.gov/fhir/test/StructureDefinition/bha-ethnicity']) &lt;= 1">extension with URL = 'http://bha.colorado.gov/fhir/test/StructureDefinition/bha-ethnicity': maximum cardinality of 'extension' is 1</sch:assert>
